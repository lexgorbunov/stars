...
public class Particle {
    ...
    public function Particle(orignWidth:Number, orignHeight:Number, scalemin:Number, scalemax:Number, speedx:Number, speedy:Number, speedrot:Number, displayRect:Rectangle) {
        this.speedx = speedx;
        this.speedy = speedy;
    ...
    public function setColor(r:Number, g:Number, b:Number, alpha:Number = 1) {
